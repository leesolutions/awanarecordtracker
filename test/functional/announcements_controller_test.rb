...
class AnnouncementsControllerTest < ActionController::TestCase
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post :create, announcement: { content: @announcement.content, expiration: @announcement.expiration, title: @announcement.title }
    end
  ...
  test "should update announcement" do
    put :update, id: @announcement, announcement: { content: @announcement.content, expiration: @announcement.expiration, title: @announcement.title }
    assert_redirected_to announcement_path(assigns(:announcement))
  end
